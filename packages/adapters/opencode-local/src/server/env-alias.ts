 ...
 * Mirrors the pi-local helper — used so opencode-local at fallback levels
 * can use OPENROUTER_FALLBACK_API_KEY (or _TERTIARY_) without overwriting
 * the global OPENROUTER_API_KEY in the parent process.
 *
